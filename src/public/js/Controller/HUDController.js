...
export class HUDController {
    ...
    createTowerButtons() {
        ...
        for(const key in enumTower){
            ...
            let fullName = enumTower[key].fullName;
            if(fullName === "Rock"){
                fullName += " (block the path)"
            }
            button.innerHTML = '<p>'+fullName+' <img height="40px" src="'+enumTower[key].path[0]+'"><br><br> '+enumTower[key].price[0]+' 🪙</p>';
            button.onclick = () => {
